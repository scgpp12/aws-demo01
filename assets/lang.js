...
const LANG_PACK = {
  ...
  zh: {
    ...
    terms: {
      ...
      publicaccess: { name: "公开访问 Public Access", desc: "指允许任何人通过链接访问你的文件。S3 默认是「阻止公开访问」的,以保护数据安全。" },
  ...
  ja: {
    ...
    terms: {
      ...
      publicaccess: { name: "パブリックアクセス Public Access", desc: "誰でもリンク経由でファイルにアクセスできる状態。S3 は初期状態で「ブロック」され、データを保護します。" },
